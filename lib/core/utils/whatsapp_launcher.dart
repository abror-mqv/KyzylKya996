...
class WhatsAppLauncher {
  ...
  static Future<void> _showNotInstalledDialog(
      BuildContext context, String waPhone, String message,
      {required bool ios}) async {
    final storeUrl = ios
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                        ios ? 'open_app_store'.tr() : 'open_play_market'.tr()),
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    onPressed: () async {
                      final e164 =
                          waPhone.startsWith('996') ? '+$waPhone' : '+$waPhone';
