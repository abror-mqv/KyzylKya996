...
import 'package:kyzylkya996/screens/full_image_screen.dart';
import 'package:provider/provider.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:kyzylkya996/data/models/ad_model.dart';
...
import 'package:kyzylkya996/features/home/ad_buttons_row.dart';
import 'dart:math';
import 'package:url_launcher/url_launcher.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:flutter/services.dart';
import 'package:kyzylkya996/utils/sound_helper.dart';
import 'package:kyzylkya996/core/models/category.dart';
import 'package:kyzylkya996/core/widgets/category_chip.dart';
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          try {
                                            ...
                                            final cleaned = rawPhone.replaceAll(
                                                RegExp(r"[^0-9+]"), "");
                                            ...
                                            debugPrint(
                                                '[Dialer] Attempting to dial');
                                            debugPrint(
                                                '[Dialer] rawPhone: "$rawPhone"');
                                            debugPrint(
                                                '[Dialer] cleaned: "$cleaned"');
                                            ...
                                            if (canDial) {
                                              ...
                                              debugPrint(
                                                  '[Dialer] launchUrl result: $launched');
                                              if (!launched && mounted) {
                                                ScaffoldMessenger.of(context)
                                                    .showSnackBar(
                                                  const SnackBar(
                                              ...
                                              ScaffoldMessenger.of(context)
                                                ...
                                                const SnackBar(
                                                    content: Text(
                                                        'Приложение телефона недоступно')),
                                              );
                                            }
                                          } catch (e, st) {
                                            debugPrint(
                                                '[Dialer] Exception: $e');
                                            debugPrint(
                                                '[Dialer] StackTrace: $st');
                                            if (mounted) {
                                              ScaffoldMessenger.of(context)
                                                  .showSnackBar(
                                                SnackBar(
                                                    content: Text(
                                                        'Ошибка при попытке звонка: $e')),
                                              );
                                            }
                                          }
                                        },
              ...
              children: [
                ...
                Container(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      final sharePromo =
                          context.read<ContactInfoProvider>().shareText;
                      final shareText = '''
${ad.title}
